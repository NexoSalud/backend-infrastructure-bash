...
modules=("backend-module-gateway" "backend-module-users" "backend-module-employees" "backend-module-schedule")
...
echo "   • gatewaydb (gateway)"
echo "   • usersdb (usuarios)"
echo "   • employeesdb (empleados)"
echo "   • scheduledb (horarios)"